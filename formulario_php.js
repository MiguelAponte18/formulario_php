   ...
   //para el envio del correo se necesita un servidor que ppermita la codificacion para emails, por lo tanto el servidor local desde apache nose puede, se necesita un programa especial
    ...
    d.addEventListener("submit",e=>{
     ...
     const options = {
        ...
        mode: "cors"//esto se aciva para que permita el intercambio de informacion entre servidores, corss son reglas o politias que indican que los recursos que consuma ajax tienen que esstar en el mismo servidor, por defecto es no-cors
    }
     fetch("assets/send_mail.php",options)
